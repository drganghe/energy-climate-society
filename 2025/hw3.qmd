...
- We will be focusing on:
  ...
  - [Real_Time_Dispatch_Actual_Load](OASIS_Real_Time_Dispatch_Actual_Load.xlsx) (5-min interval)
  
- Preprocessed dataset: I have cleaned and combined the dataset in R. The [Combined_Load_Forecast_Actual_Data](Combined_Load_Forecast_Actual_Data.csv) file is available for you to use. If you’re interested, you can access the [R code](hw3.R) to replicate or modify the dataset.

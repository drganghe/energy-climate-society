---
title: "Lecture 6 Energy Conversion Technologies"
description-meta: "How do thermal technology, wind, and solar work"
author: "Gang He"
date: March 9, 2026
date-format: long
image: "https://raw.githubusercontent.com/drganghe/shared-files/refs/heads/main/images/hybrid-power-systems.png"
format:
  revealjs:
    theme: white
...
![]({{< var file_path >}}/images/heat_engine.png){fig-align="center"}
...
![]({{< var file_path >}}/images/gas-turbine-engine.png){fig-align="center"}
...
![]({{< var file_path >}}/images/coal_fired_power_plant_diagram.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![]({{< var file_path >}}/images/Brayton_cycle.png){fig-align="center"}
...
::: {.column width="50%"}
![]({{< var file_path >}}/images/Rankine_cycle.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![]({{< var file_path >}}/images/georgia_power_plant_scherer.png){fig-align="center"}
:::
...
![]({{< var file_path >}}/images/GE-CCGT-diagram.png){fig-align="center"}
...
![]({{< var file_path >}}/images/Solar_spectrum.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![Heqing Solar Cooker Project in Zhangye]({{< var file_path >}}/images/Heqing_Solar_Cooker_photo.webp){fig-align="center"}
:::

::: {.column width="50%"}
![Young NaDEET students in Namibia learning to use a parabolic solar cooker]({{< var file_path >}}/images/NaDEET_solar_cooking_training.webp){fig-align="center"}
:::
:::
...
<center>
![]({{< var file_path >}}/images/silicon-atomic-structure.jpeg){width=50% fig-align="center"}


::: columns
::: {.column width="50%"}
![]({{< var file_path >}}/images/Boron-atomic-structure.jpeg){width=80% fig-align="center"}
:::

::: {.column width="50%"}
![]({{< var file_path >}}/images/Phosphorus-atomic-structure.jpeg){width=80% fig-align="center"}
:::
:::
</center>
...
::: columns
::: {.column width="30%"}
![]({{< var file_path >}}/images/silicon-lattice.png){fig-align="center"}
:::

::: {.column width="30%"}
![]({{< var file_path >}}/images/p-type-silicon.png){fig-align="center"}
:::

::: {.column width="30%"}
![]({{< var file_path >}}/images/n-type-silicon.png){fig-align="center"}
:::
...
![]({{< var file_path >}}/images/p-n-junction.png){fig-align="center"}
...
::: {.column width="50%"}
![]({{< var file_path >}}/images/solar-irradiance.png){fig-align="center"}
:::
:::
...
![]({{< var file_path >}}/images/best-research-cell-efficiencies.webp){fig-align="center"}
...
![]({{< var file_path >}}/images/World_PVOUT_map.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![]({{< var file_path >}}/images/pm-and-solar.gif){fig-align="center"}
:::

::: {.column width="50%"}
![]({{< var file_path >}}/images/global-pm-solar-reduction.jpeg){fig-align="center"}
:::
...
![]({{< var file_path >}}/images/prioritizing-solar-deployment.png){fig-align="center"}
...
![]({{< var file_path >}}/images/Concentrating-Solar-Thermal-Power-Applications.png){fig-align="center"}
...
![]({{< var file_path >}}/images/block-island-wind.jpeg){fig-align="center"}
...
![]({{< var file_path >}}/images/upwind-downwind.png){fig-align="center"}

:::

::: {.column width="50%"}
![]({{< var file_path >}}/images/blade-efficiency.png){fig-align="center"}
:::
...
![]({{< var file_path >}}/images/wind-distribution.png){fig-align="center"}
...
![]({{< var file_path >}}/images/wind-power-curve.png){fig-align="center"}
...
![]({{< var file_path >}}/images/global-wind-power-density-map.webp){fig-align="center"}
...
::: {.column width="50%"}
![]({{< var file_path >}}/images/turbine-hub-height-rotor-capacity.png){fig-align="center"}
:::

::: {.column width="50%"}
![]({{< var file_path >}}/images/Turbine-Hub-Height-Chart.png){fig-align="center"}
:::
...
![]({{< var file_path >}}/images/US_Wind_Power_Resource_at_100-Meter_Hub_Height.webp){fig-align="center"}
...
::: {.column width="50%"}
![]({{< var file_path >}}/images/offshore-floating-turbines.png){fig-align="center"}
:::

::: {.column width="50%"}
![]({{< var file_path >}}/images/resources-demand-offshore-us.png){width="70%" fig-align="center"}
:::
...
![]({{< var file_path >}}/images/grazing-animals-like-sheep-enjoy-using-the-shadows-of-wind.webp){fig-align="center"}
...
![]({{< var file_path >}}/images/hybrid-power-systems.png){fig-align="center"}

---
title: "Lecture 9 Energy Transition and Power Sector Decarbonization"
description-meta: "Energy, Electrification, and Power Systems Transition"
author: "Gang He"
date: March 30, 2026
date-format: long
image: "https://raw.githubusercontent.com/drganghe/shared-files/refs/heads/main/images/us-energy-consumption-1776-2023.svg"
format:
  revealjs:
    theme: white
...
-   How geo-politics, wars, and pandemic impact the energy in transition?\

## Transition history

![]({{< var file_path >}}/images/us-energy-consumption-1776-2023.svg){fig-align="center"}
...
![]({{< var file_path >}}/images/us-re-coal-1950-2023.svg){fig-align="center"}
...
## Fossil fuel share less than 50%

![]({{< var file_path >}}/images/fossil-less-than-50-percent-us.png){fig-align="center"}

::: footer
Source: [Ember](https://ember-energy.org/latest-updates/fossil-fuels-fall-below-50-of-us-electricity-for-the-first-month-on-record/)
:::
...
![]({{< var file_path >}}/images/hard-soft-path-2025.png){fig-align="center"}

::: columns

::: {.column width="50%"}
Central, large scale, increasing supply/demand     
Fossil, nuclear
:::
...
## The momentum of the solar energy

![]({{< var file_path >}}/images/cheapest-electricity-source-by-year.webp){fig-align="center"}

::: footer
Source: @nijsseMomentumSolarEnergy2023
:::
...
::: columns
::: {.column width="50%"}
![]({{< var file_path >}}/images/brazil-energy-mix-2021.png){fig-align="center"}
:::

::: {.column width="50%"}
![]({{< var file_path >}}/images/brazil-power-mix-2021.png){fig-align="center" width="90%"}
:::
...
![]({{< var file_path >}}/images/us-electricity-flow-2023.png){fig-align="center"}
...
![]({{< var file_path >}}/images/us-transmission-grid.png){fig-align="center"}
...
![]({{< var file_path >}}/images/load-profile-load-duration-curve.png){fig-align="center"}
...
![]({{< var file_path >}}/images/DispatchCurve.png){fig-align="center"}
...
![]({{< var file_path >}}/images/switch-model.jpg){fig-align="center"}
...
![]({{< var file_path >}}/images/hourly-dispatch.jpg){fig-align="center"}
...
![]({{< var file_path >}}/images/pypsa-eur.png){fig-align="center"}

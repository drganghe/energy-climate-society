...
date-format: long
image: "/lectures/images/18/hourly-dispatch.jpg"
format:
  revealjs:
    theme: white
...
![](/lectures/images/18/US-electricity-flow-2021.png){fig-align="center"}
...
![](/lectures/images/18/us-transmission-grid.png){fig-align="center"}
...
![](/lectures/images/18/load-profile-load-duration-curve.png){fig-align="center"}
...
![](/lectures/images/18/DispatchCurve.png){fig-align="center"}
...
![](/lectures/images/18/model-comparison.png){fig-align="center"}
...
![](/lectures/images/18/switch-model.jpg){fig-align="center"}
...
![](/lectures/images/18/hourly-dispatch.jpg){fig-align="center"}
...
![](/lectures/images/18/pypsa-eur.png){fig-align="center"}
...
::: footer
Back to Title [Slide](https://drganghe.github.io/energy-climate-society/lectures/lecture18.html#title-slide), All [Lectures](https://drganghe.github.io/energy-climate-society/lectures.html), Course [Home](https://drganghe.github.io/energy-climate-society/), or Learn More About [Gang He](https://drganghe.github.io)
:::

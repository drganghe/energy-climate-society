...
date-format: long
image: "/lectures/images/9/heat_engine.png"
format:
  revealjs:
    theme: white
...
![](/lectures/images/9/heat_engine.png){fig-align="center"}
...
![](/lectures/images/9/gas-turbine-engine.png){fig-align="center"}
...
![](/lectures/images/9/coal_fired_power_plant_diagram.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](/lectures/images/9/Brayton_cycle.png){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/9/Rankine_cycle.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](/lectures/images/9/georgia_power_plant_scherer.png){fig-align="center"}
:::
...
![](/lectures/images/9/GE-CCGT-diagram.png){fig-align="center"}
